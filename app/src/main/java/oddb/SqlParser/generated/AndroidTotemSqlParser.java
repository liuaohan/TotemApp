...
public class AndroidTotemSqlParser implements AndroidTotemSqlParserConstants {
  ...
  final public List<Statement> statements() throws ParseException {List<Statement> statements = new ArrayList<Statement>();
    Statement s;
    label_1:
    while (true) {
...
{if ("" != null) return s;}
  ...
  final public SelectStatement selectStatement() throws ParseException {List<Projection> projectionList;
    String className;
...
{if ("" != null) return new SelectStatement(projectionList, className, whereClause);}
  ...
  final public List<Projection> projectionList() throws ParseException {List<Projection> projectionList = new ArrayList<Projection>();
...
{if ("" != null) return projectionList;}
  ...
  final public Projection projection() throws ParseException {Projection projection;
    String name = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LEFT_BRACKET:{
...
projection.name = name;
  ...
  final public BinaryProjection binaryProjection() throws ParseException {BinaryExpression expression;
...
{if ("" != null) return new BinaryProjection(expression);}
  ...
  final public BinaryExpression binaryExpression() throws ParseException {SimpleExpression left, right;
...
{if ("" != null) return new BinaryExpression(left, right, operator);}
  ...
  final public SimpleExpression simpleExpression() throws ParseException {Object value;
    PropertyType type;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case IDENTIFIER:{
      value = identifier();
...
{if ("" != null) return Integer.parseInt(token.image);}
  ...
  final public OperatorType operator() throws ParseException {Token token;
    token = jj_consume_token(BINARY_OPERATOR);
{if ("" != null) return OperatorType.typeOf(token.image);}
    throw new Error("Missing return statement in function");
  }

  final public CrossClassProjection crossClassProjection() throws ParseException {List<String> classNames = new ArrayList<String>();
    String className;
    String propertyName;
    className = identifier();
...
{if ("" != null) return new CrossClassProjection(classNames, propertyName);}
  ...
  final public SimpleProjection simpleProjection() throws ParseException {String name;
    name = identifier();
{if ("" != null) return new SimpleProjection(name);}
    throw new Error("Missing return statement in function");
  }

  final public WhereClause whereClause() throws ParseException {BinaryExpression expression;
    expression = binaryExpression();
{if ("" != null) return new WhereClause(expression);}
    throw new Error("Missing return statement in function");
  }

  final public String identifier() throws ParseException {Token token;
    token = jj_consume_token(IDENTIFIER);
{if ("" != null) return token.image;}
    throw new Error("Missing return statement in function");
  }

  final public CreateClassStatement createClassStatement() throws ParseException {String className;
...
{if ("" != null) return new CreateClassStatement(className, propertyList);}
  ...
  final public List<Property> propertyList() throws ParseException {List<Property> propertyList = new ArrayList<Property>();
    Property property;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LEFT_BRACKET:{
      jj_consume_token(LEFT_BRACKET);
...
{if ("" != null) return propertyList;}
  ...
  final public Property property() throws ParseException {String name;
    PropertyType type;
    name = identifier();
    type = propertyType();
{if ("" != null) return new Property(name, type);}
  ...
  final public PropertyType propertyType() throws ParseException {Token token;
    token = jj_consume_token(TYPE);
{if ("" != null) return PropertyType.typeOf(token.image);}
    throw new Error("Missing return statement in function");
  }

  final public CreateDeputyStatement createDeputyStatement() throws ParseException {String className;
    List<Property> propertyList;
...
{if ("" != null) return new CreateDeputyStatement(className, propertyList, select);}
  ...
  final public InsertStatement insertStatement() throws ParseException {String className;
...
{if ("" != null) return new InsertStatement(className, propertyList, valueList);}
  ...
  final public List<String> identifierList() throws ParseException {List<String> identifierList = new ArrayList<String>();
    String identifier;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LEFT_BRACKET:{
      jj_consume_token(LEFT_BRACKET);
...
{if ("" != null) return identifierList;}
  ...
  final public List<SimpleExpression> valueList() throws ParseException {List<SimpleExpression> valueList = new ArrayList<SimpleExpression>();
...
{if ("" != null) return valueList;}
  ...
  final public String string() throws ParseException {Token token;
...
String image = token.image;
  ...
  final public UpdateStatement updateStatement() throws ParseException {String className;
    String propertyName;
...
propertyName = (String) expression.left.value;
  ...
  final public DeleteStatement deleteStatement() throws ParseException {String className;
    WhereClause whereClause;
...
{if ("" != null) return new DeleteStatement(className, whereClause);}
  ...
  final public DropStatement dropStatement() throws ParseException {String className;
