    ...
    private void showBiTab(BiPointerTable biPointerT) {
        ...
        for (int i = 0; i <= tabH; i++) {
            ...
            if (i == 0) {
                ...
                oj1 = biPointerT.getBiPointerTable().get(i - 1).getOriginClassId();
                oj2 = biPointerT.getBiPointerTable().get(i - 1).getOriginObjectId();
                oj3 = biPointerT.getBiPointerTable().get(i - 1).getDeputyClassId();
                oj4 = biPointerT.getBiPointerTable().get(i - 1).getDeputyObjectId();
                stemp1 = oj1.toString();
                stemp2 = oj2.toString();
                stemp3 = oj3.toString();
                stemp4 = oj4.toString();
