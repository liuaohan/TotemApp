    ...
    private void showObjTab(ObjectTable topt) {
        ...
        for (int i = 0; i <= tabH; i++) {
            ...
            if (i == 0) {
                ...
                oj1 = topt.objectTable.get(i - 1).getClassId();
                oj2 = topt.objectTable.get(i - 1).getObjectId();
                oj3 = topt.objectTable.get(i - 1).getBlockId();
                oj4 = topt.objectTable.get(i - 1).getOffset();
                stemp1 = oj1.toString();
                stemp2 = oj2.toString();
                stemp3 = oj3.toString();
                stemp4 = oj4.toString();
